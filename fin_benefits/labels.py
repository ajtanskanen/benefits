...
class Labels():
    def get_labels(self,language='English'):
        ...
        if language=='English' or language=='eng' or language=='Eng':
            ...
            labels['ansiosidonnainen']='Earnings-related unemployment benefit'
            labels['tm-tuki']='Job market support'
            labels['lisäpäivät']='Additional days'
            ...
            labels['elake']='Eläke'
            labels['ansiosidonnainen']='Ansiosidonnainen'
            labels['lisäpäivät']='Lisäpäivät'
            labels['tm-tuki']='Työmarkkinatuki'
