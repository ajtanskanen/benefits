...
class BenefitsPuoliväliriihi2025(Benefits):
    ...
    def laske_tyotulovahennys2024_puoliväliriihi(self,puhdas_ansiotulo: float,palkkatulot_puhdas: float,ika: float,lapsia: float):
        ...
        Vuosille 2023-
        '''
        max_tyotulovahennys,ttulorajat,ttulopros = self.tyotulovahennys2024_puoliväliriihi(ika,lapsia)
    ...
    def tyotulovahennys2026_puoliväliriihi(self,ika: float,lapsia: int):
        if ika>=65:
            max_tyotulovahennys=3340/self.kk_jakaja
        else:
            max_tyotulovahennys=2140/self.kk_jakaja
    ...
    def laske_tyotulovahennys2026_puoliväliriihi(self,puhdas_ansiotulo: float,palkkatulot_puhdas: float,ika: float,lapsia: float):
        '''
        Vuosille 2023-
        '''
        max_tyotulovahennys,ttulorajat,ttulopros = self.tyotulovahennys2026_puoliväliriihi(ika,lapsia)
